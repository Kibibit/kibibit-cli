...
kbString.printFlash = printFlash;
...
function kibibitLogo(big) {
  if (big) {
    return kbString.build([
      ' _    ', kbString.error('_'), ' _     ', kbString.info('_'),
      ' _     ', kbString.warning('_'), ' _   \n',
      '| | _', kbString.error('(_)'), ' |__ ', kbString.info('(_)'),
      ' |__ ', kbString.warning('(_)'), ' |_ \n',
      '| |/ / ', kbString.error('|'), ' \'_ \\', kbString.info('| |'),
      ' \'_ \\', kbString.warning('| |'), ' __|\n',
      '|   <', kbString.error('| |'), ' |_) ', kbString.info('| |'),
      ' |_) ', kbString.warning('| |'), ' |_ \n',
      '|_|\\_\\', kbString.error('_|'), '_.__/', kbString.info('|_|'),
      '_.__/', kbString.warning('|_|'), '\\__|\n'
    ]);
  }
  return kbString.build([
    kbString.white('k'),
